...
@section('content')
    <section class="space-y-6">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
            ...
            <a
                href="{{ route('teacher.interviews.create') }}"
                        ...
                        @forelse ($interviewRecords as $interviewRecord)
                            <tr class="align-top lms-hover-bg-neutral-subtle">
                                ...
                                <td class="px-5 py-4 text-sm">
                                    ...
                                    $interviewRecord->student->classGroup->class_name }}</p>
                                </td>
                                <td class="max-w-md px-5 py-4 text-sm lms-text-neutral-secondary">
                                    {{ $interviewRecord->next_action !== null ?
                                    \Illuminate\Support\Str::limit($interviewRecord->next_action, 120) : '-' }}
                                </td>
                                <td class="px-5 py-4 text-sm">
                                ...
                                <td class="whitespace-nowrap px-5 py-4 text-right text-sm">
                                    <a
                                        href="{{ route('teacher.interviews.edit', $interviewRecord) }}"
                                        class="font-semibold lms-link-primary"
                                    >詳細・編集</a>
                                </td>
                            </tr>
